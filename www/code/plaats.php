...
<form method="post" action="?action=lijst&plaatsstukje=<?php echo $_GET['stukje']; ?>">
<div class='row'>
	<?php
	if (count($checks) > 0) {
		echo "<div class='col-sm-12 text-right'>Nagekeken door " . htmlspecialchars(implode(', ', $checks)) . ".</div>";
	}
	?>
