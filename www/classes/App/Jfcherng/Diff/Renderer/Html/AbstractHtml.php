...
namespace App\Jfcherng\Diff\Renderer\Html;

use App\Jfcherng\Diff\Differ;
use App\Jfcherng\Diff\Factory\LineRendererFactory;
use App\Jfcherng\Diff\Renderer\AbstractRenderer;
use App\Jfcherng\Diff\Renderer\Html\LineRenderer\AbstractLineRenderer;
use App\Jfcherng\Diff\Renderer\RendererConstant;
use App\Jfcherng\Diff\SequenceMatcher;
    ...
    protected function htmlFixSpaces(string $string): string
    {
        return preg_replace_callback(
            ...
            static function (array $matches): string {
                ...
                return AbstractHtml . phpstr_repeat(' &nbsp;', $count >> 1);
            },
            $string,
        );
    }
